...
See [Detect Kerberos RC4 usage](https://learn.microsoft.com/en-us/windows-server/security/kerberos/detect-rc4) for Microsoft's official usage guidance.  These scripts are used in the [AES Standardization Guide](security/aes-standardization.md#step-1-audit-current-state) audit step.
